...
func (dw *weeklyWork) LoadTop3() ([]*domainModel.Work, error) {
...
func (dw *weeklyWork) LoadByScreenName(screenName string) (*domainModel.Work, error) {
...
func (dw *weeklyWork) Save(entity *domainModel.Work) error {
